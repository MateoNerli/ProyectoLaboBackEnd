            ...
            modelBuilder.Entity<User>(entity =>
            {
                ...
                entity.HasMany(d => d.Posts)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "Like",
                        l => l.HasOne<Post>().WithMany().HasForeignKey("PostId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("likes_ibfk_1"),
                        r => r.HasOne<User>().WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("likes_ibfk_2"),
                        j =>
                        {
                ...
                entity.HasMany(d => d.Posts1)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        "Saved",
                        l => l.HasOne<Post>().WithMany().HasForeignKey("PostId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("saved_ibfk_1"),
                        r => r.HasOne<User>().WithMany().HasForeignKey("UserId").OnDelete(DeleteBehavior.ClientSetNull).HasConstraintName("saved_ibfk_2"),
                        j =>
                        {
                            j.HasKey("UserId", "PostId").HasName("PRIMARY").HasAnnotation("MySql:IndexPrefixLength", new[] { 0, 0 });
